...
def run_scraper(limit=30, sleep_sec=5):
    ...
    output_file = os.path.join(OUTPUT_DIR, f"fanqie_nan_new_ranks_{date_str}.json")
    ...
    with sync_playwright() as p:
        ...
        init_url = "https://fanqienovel.com/rank/1_1_751"
        print(f"[{datetime.now().strftime('%H:%M:%S')}] 正在访问男频新书榜：{init_url}")
